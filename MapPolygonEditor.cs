...
public class MapPolygonEditor : Editor {
	...
	private void CapDotMinus        (int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize) {MapGen.EditorTools.ImageCapBase(aControlID, aPosition, aRotation, aSize, texMinus);}
	private void CapDotMinusSelected(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize) {MapGen.EditorTools.ImageCapBase(aControlID, aPosition, aRotation, aSize, texMinusSelected);}
	private void CapDot             (int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize) {MapGen.EditorTools.ImageCapBase(aControlID, aPosition, aRotation, aSize, texDot);}
	private void CapDotPlus         (int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize) {MapGen.EditorTools.ImageCapBase(aControlID, aPosition, aRotation, aSize, texDotPlus);}
	private void CapDotSelected     (int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize) {MapGen.EditorTools.ImageCapBase(aControlID, aPosition, aRotation, aSize, texDotSelected);}
	...
	void LoadTextures() {
		...
		texMinus           = MapGen.EditorTools.GetGizmo("Assets/ArtResource/ArtScripts/MapDataEditor/dot-minus.png"         );
		texMinusSelected   = MapGen.EditorTools.GetGizmo("Assets/ArtResource/ArtScripts/MapDataEditor/dot-minus-selected.png");
		texDot             = MapGen.EditorTools.GetGizmo("Assets/ArtResource/ArtScripts/MapDataEditor/dot.png"               );
		texDotPlus         = MapGen.EditorTools.GetGizmo("Assets/ArtResource/ArtScripts/MapDataEditor/dot-plus.png"          );
		texDotSelected     = MapGen.EditorTools.GetGizmo("Assets/ArtResource/ArtScripts/MapDataEditor/dot-selected.png"      );
	}
